...
function CourseCard({ course, onEnroll }: { course: Course; onEnroll: (course: string) => void }) {
  return (
...
export default function Courses({ onEnroll }: { onEnroll: (course: string) => void }) {
  return (
    <section id="courses" className="bg-navy-900 py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Our Courses</h2>
          <p className="text-slate-400 text-lg max-w-xl mx-auto">
            Structured learning paths designed to take you from curious beginner to confident AI
            practitioner.
          </p>
        </div>
